      ...
      <div className="max-w-420 mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-sm text-text-sub dark:text-gray-400 mb-4 leading-relaxed">
              Subscribe to our newsletter for exclusive drops and 10% off your
              first order.
            </p>
            <form className="flex flex-col gap-3">
              <input
                className="w-full px-4 py-3 rounded-lg border border-border-subtle dark:border-gray-700 bg-surface-light dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all text-sm"
                placeholder="Enter your email"
                required
                type="email"
              />
              <button
                className="w-full px-4 py-3 bg-primary hover:bg-primary-hover text-white font-bold rounded-lg transition-colors shadow-sm hover:shadow-primary/30"
                type="submit"
              >
                Subscribe
              </button>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between border-t border-border-subtle dark:border-gray-800 pt-8 gap-4">
